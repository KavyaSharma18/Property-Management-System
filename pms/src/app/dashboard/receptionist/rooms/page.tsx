...
// import { Search, DoorOpen, Users, X } from "lucide-react";
...
// 			prevRooms.map((room) => {
// 				if (room.id === id) {
// 					// Do not toggle rooms under maintenance
// 					if (room.status === "maintenance") return room;
// 					const newStatus = room.status === "occupied" ? "vacant" : "occupied";
// 					return { ...room, status: newStatus, guests: newStatus === "vacant" ? 0 : room.guests };
// 				}
// 				return room;
// 			})
// 		);
...
// 									<p className="text-sm text-muted-foreground">Type: <span className="font-medium text-foreground">{selectedRoom.type}</span></p>
// 									<p className="text-sm text-muted-foreground">Status: <span className="font-medium text-foreground">{selectedRoom.status}</span></p>
// 									<p className="text-sm text-muted-foreground">Capacity: <span className="font-medium text-foreground">{selectedRoom.capacity}</span></p>
// 									<p className="text-sm text-muted-foreground">Guests: <span className="font-medium text-foreground">{selectedRoom.guests}</span></p>
// 									<p className="text-sm text-muted-foreground">Price/night: <span className="font-medium text-foreground">${selectedRoom.pricePerNight}</span></p>
// 								</div>
// 								<div className="flex items-center gap-3 p-4 border-t">
// 									<button onClick={closeRoomModal} className="px-3 py-2 rounded-md bg-gray-100 hover:bg-gray-200">Close</button>
// 									{/* placeholder for future actions inside modal */}
// 								</div>
// 							</div>
// 						</div>
// 					)}
...
// 			// If room is occupied, mark as vacant
// 			setRooms((prevRooms) =>
// 				prevRooms.map((r) =>
// 					r.id === id ? { ...r, status: "vacant", guests: 0 } : r
// 				)
// 			);
// 		}
// 	};
...
// 			prevRooms.map((room) =>
// 				room.id === roomId
// 					? { ...room, status: "occupied", guests: checkInData.numberOfGuests }
// 					: room
// 			)
// 		);
